  ...
  return (
    <div className={`relative ${className}`}>
      <img
        src={src}
        alt={alt || '사용자'}
        className="h-8 w-8 rounded-full object-cover shadow-lg ring-2 ring-white transition-all duration-300 hover:scale-120 hover:shadow-2xl dark:ring-white/20 dark:hover:shadow-stone-700"
        style={{
